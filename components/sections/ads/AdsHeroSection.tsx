  ...
  return (
    <section className="pt-[72px] lg:pt-[72px]">
      <div className="max-w-[1080px] mx-auto px-5 py-[32px] lg:py-[60px]">
        <div className="bg-[#f5f7fa] rounded-[24px] px-[20px] py-[40px] lg:px-[32px] lg:py-[60px] text-center relative overflow-hidden">
          {/* Badge */}
          ...
          {/* Subtitle */}
          <h3 className="text-[16px] lg:text-[18px] font-[500] text-[#454F5D] leading-[1.4] mb-[20px]">
